    ...
    public partial class Deploy : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                obdcconn.ConnectionString = GetConnection(System.Configuration.ConfigurationSettings.AppSettings["InputPath"]);
                obdcconn.Open();
                ...
                lblStatus.Text = "File conversion completed, file is in " + dir + "\\" + fileName;
                //}
            }
        ...
        public static void WriteDataToTemplate(string filePath, string fileName, DataTable table)
        {
            ...
            try
            {
                OleDbConnection obdcconn = new OleDbConnection(GetConnection(dir));
